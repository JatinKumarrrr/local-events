          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-slate-600 leading-relaxed max-w-xl">
                Join your community through curated local experiences. From
                workshops to meetups—find what moves you.
              </p>
      ...
      <section className="container-custom py-24">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-slate-600">
            Whether you're attending or organizing, we've made it simple,
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="group p-8 rounded-2xl hover:bg-slate-50 transition-colors">
            ...
            <p className="text-slate-600 leading-relaxed">
              Discover curated events in your area. RSVP instantly and manage
              your calendar in one place.
            </p>
          </div>
          ...
          <div className="group p-8 rounded-2xl hover:bg-slate-50 transition-colors">
            ...
            <p className="text-slate-600 leading-relaxed">
              Create and manage events effortlessly. Track attendance,
          ...
          <div className="group p-8 rounded-2xl hover:bg-slate-50 transition-colors">
            ...
            <p className="text-slate-600 leading-relaxed">
              Stay in the loop with instant notifications. Never miss an update
      ...
      <section className="bg-slate-50 py-24">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              From professional networking to creative workshops, find what
              speaks to you
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Set up your event in minutes with our intuitive form. Add
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    See who's coming in real-time. Set capacity limits and
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Access complete attendee lists with contact information for
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Edit or cancel events anytime. You're always in charge of
                    your community.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="flex gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Explore events filtered by your interests, location, and
                  schedule. Our curated feed shows what's relevant to you.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Reserve your spot with a single click. Get instant
                  confirmation and add it to your calendar.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Show up and engage with your community. Build meaningful
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 hover:border-amber-200 transition-colors">
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">
              "LocalEvents made organizing our community meetups so much easier.
              The RSVP system is perfect!"
            </p>
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 hover:border-amber-200 transition-colors">
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">
              "I've discovered so many amazing events near me. The interface is
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-200 hover:border-amber-200 transition-colors">
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">
              "As a workshop host, this platform has helped me reach more people
              and manage registrations efficiently."
            </p>
            <div className="flex items-center gap-3">
